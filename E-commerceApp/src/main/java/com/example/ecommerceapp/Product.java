...
public class Product {
    ...
    public static ObservableList<Product> searchRelatedProducts(String searchQuery) {
        String selectAllProducts = "SELECT id, name, price FROM product WHERE name like '%" + searchQuery + "%'";
        return fetchProductData(selectAllProducts);
    }
